...
int main() {
	...
	wBox::transform cubeTransform;
	/*cubeTransform.mTranslate = glm::vec3(0, 0, 0);
	cubeTransform.mRotate = glm::vec3(0, 0, 0);
	cubeTransform.mScale = glm::vec3(1, 1, 1);*/

	glm::mat4 totalMatrix = glm::mat4(1);
